...
// include "connection.php";
// require 'vendor/autoload.php'; // Ensure you have installed the QR code library via Composer
...
//                 // Generate QR code data with only occupantId and vehicleId
//                 $qrCodeData = json_encode([
//                     'occupantId' => $sanitizedData['occupantId'],
//                     'vehicleId' => $vehicleId
//                 ]);
...
//                 // Store QR code in tbloccupant
//                 $stmt = $conn->prepare("UPDATE tbloccupant SET QR_Code = ? WHERE Occupant_ID = ?");
//                 $stmt->execute([$qrCodeImageData, $sanitizedData['occupantId']]);
...
//                 // Return error response
//                 http_response_code(500); // Internal Server Error
//                 echo json_encode(['error' => 'Error adding vehicle: '. $e->getMessage()]);
//             } catch (Exception $e) {
//                 // Log error message
//                 error_log('Exception - '. $e->getMessage());
